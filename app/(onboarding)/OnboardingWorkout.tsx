...
import CustomSVG from "../../assets/svg/DumbbellSvg";
  ...
  return (
    <View style={[styles.container, { marginBottom: bottom }]}>
      ...
      <View style={styles.bottomSection}>
        <NextScreen to={"Onboarding_Calories"} />
      </View>
    </View>
  );
};
...
const styles = StyleSheet.create({
  ...
  title: {
    color: Colors.Secondary, // Light text color on dark background
    fontSize: 26,
    fontWeight: "bold",
    textAlign: "center",
    marginBottom: 10,
...
export default OnboardingWorkout;
